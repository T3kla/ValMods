...
namespace Areas
{
    ...
    public static class DungeonHandler
    {
        ...
        public static void Regenerate(DungeonGenerator dg)
        {
            ...
            switch (msg)
            {
                case "RegenSuccess":
                    ...
                    break;
                case "PlayerInside":
                    Main.GLog.LogWarning($"Regen output: Dungeon \"{dg.GetCleanName()}\" couldn't regenerate because a player was found inside!");
                    regenAtSecond = (long)ZNet.instance.GetTimeSeconds() + Globals.Config.DungeonRegenCooldown.Value * 60;
                    break;
                case "AlreadyRegenerated":
                    Main.GLog.LogInfo($"Regen output: Dungeon \"{dg.GetCleanName()}\" was already regenerated by another instance!");
                    regenAtSecond = dg.GetRegenAtSecond();
                    break;
                case "OutOfBounds":
                    Main.GLog.LogWarning($"Regen output: Dungeon \"null\" couldn't regenerate because it was out of bounds!");
                    regenAtSecond = null;
                    break;
                default:
                    Main.GLog.LogWarning($"Regen output: Dungeon \"null\" couldn't regenerate because it was out of bounds!");
        ...
        public static void Task_Unschedule(IEnumerator task)
        {
        ...
        public static void Task_UnscheduleAll()
        {

            Main.GLog.LogInfo($"Unscheduling all Dungeon Regeneration tasks");
